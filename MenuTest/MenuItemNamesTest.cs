/*
 * File name: MenuItemNamesTest.cs
 * Modified by: Marissa Shivers
 */
using System;
...
namespace MenuTest
{
    public class MenuItemNamesTest
    {
        ...
        [Fact]
        public void BrontwurstDescriptionShouldGiveDescription()
        {
            Brontowurst bw = new Brontowurst();
        ...
        [Fact]
        public void DinoNuggetDescriptionShouldGiveDescription()
        {
            DinoNuggets dn = new DinoNuggets();
        ...
        [Fact]
        public void PterodactylWingsDescriptionShouldGiveDescription()
        {
            PterodactylWings pw = new PterodactylWings();
        ...
        [Fact]
        public void SteakosaurusBurgerDescriptionShouldGiveDescription()
        {
            SteakosaurusBurger sb = new SteakosaurusBurger();
        ...
        [Fact]
        public void TRexKingBurgerDescriptionShouldGiveDescription()
        {
            TRexKingBurger trex = new TRexKingBurger();
        ...
        [Fact]
        public void VelociWrapDescriptionShouldGiveDescription()
        {
            VelociWrap vw = new VelociWrap();
